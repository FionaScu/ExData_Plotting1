...
## create the plots and print to png file in the work environment which is viewable in your png viewer
...
legend("topright",c("Sub_metering_1","Sub_metering_2","Sub_metering_3"),lty=c(1,1,1),col=c("black","red","blue"),bty="n", cex=0.9, y.intersp=0.9, xjust=1)
